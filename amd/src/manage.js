define([
'core/config', 'jquery',
'report_forumkeywords/d3', 'report_forumkeywords/cloud', 'report_forumkeywords/Base64'],
function(mdlcfg, $, d3, cloud, Base64) {
    return {
        init: function(words, fid) {
            ...
            var fontScale = d3.scaleLinear().domain([minSize, maxSize]).range([20, 120]);
            ...
            function draw(words) {
                d3.select("#wordcloud").append("svg")
                  ...
                  .on("click", function (d) {
                      window.open(mdlcfg.wwwroot + "/mod/forum/search.php?id=" + fid + "&search=" + d.text, '_blank');
                  });
            }
